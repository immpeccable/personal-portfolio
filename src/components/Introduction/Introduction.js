...
import MyImage from "../images/WhatsApp Image 2022-07-09 at 21.21.13.jpeg";
import EnglishImage from '../images/united-kingdom.png'
    ...
    <div className="intro-wrapper">
      <div data-aos="fade-right" className="intro-content">
        ...
        <div className="middle-section">
          <div className="job-description">Full Stack Developer</div>
          <div className="cool-line">Thrilled to learn all about software.</div>
        </div>
        <div className="bottom-section">
          <a href="mailto:tunahan.dundar.2221@gmail.com">
            <svg
          ...
          <a href="https://www.linkedin.com/in/tunahan-dundar/">
            <svg
              className="contact-logos"
              stroke="currentColor"
              fill="currentColor"
